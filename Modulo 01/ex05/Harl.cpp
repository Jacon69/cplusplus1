...
/*   Updated: 2025/02/05 09:31:02 by jaimecondea      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::complain(std::string level) {
    ...
    /*Esto es un array de punteros a funciones miembro de la clase Harl.
    ...
    */
    ...
    for (int i = 0; i < 4; i++) {
     ...
     que se ha definido para obtener el nº (i) del metodo  que hay que ejecutar*/
            (this->*actions[i])(); // Llama a la función correspondiente lo hace con this-> para que se aplique en la istancia donde se está llamando
            return;
        }
    }
